  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('복약 기록 내보내기', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 24, color: Colors.black)),
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Text('내보낼 기간', style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold)),
              ...
              Text('내보내기 형식', style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold)),
              const SizedBox(height: 16),
              SingleChildScrollView(
                scrollDirection: Axis.horizontal,
                child: Row(
                  children: [
                    ChoiceChip(
                      label: Text('CSV', style: TextStyle(fontSize: 22)),
                      selected: _selectedFormat == 'CSV',
                      onSelected: (v) => setState(() => _selectedFormat = 'CSV'),
                    ),
                    const SizedBox(width: 16),
                    ChoiceChip(
                      label: Text('PDF', style: TextStyle(fontSize: 22)),
              ...
              Center(
                child: ElevatedButton.icon(
                  ...
                  label: Text('내보내기', style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold)),
                  ...
                  onPressed: () {
                    ...
                    showDialog(
                      ...
                      builder: (context) => AlertDialog(
                        title: Text('내보내기 준비 중', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
                        content: Text('실제 내보내기 기능은 추후 지원됩니다.', style: TextStyle(fontSize: 20)),
                        actions: [
                          TextButton(
                            onPressed: () => Navigator.pop(context),
